...
<HEAD>
  ...
  <TITLE> Dungeon War - Cookies </TITLE>
</HEAD>
  ...
  <div class="cuerpo">
    ...
    <p>This Cookies Policy explains what Cookies are and how We use them. You should read this policy so You can
      ...
      used. This Cookies Policy has been created with the help of the <a
        href="https://www.privacypolicies.com/cookies-policy-generator/" target="_blank">Cookies Policy Generator</a>.
    </p>
    ...
    <ul>
      <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
          &quot;Our&quot; in this Cookies Policy) refers to Dungeon War, Mataró.</p>
      </li>
      <li>
        <p><strong>Cookies</strong> means small files that are placed on Your computer, mobile device or any other
          device
          by a website, containing details of your browsing history on that website among its many uses.</p>
      </li>
      <li>
        <p><strong>Website</strong> refers to Dungeon War, accessible from <a href="http://www.dungeonwar.online"
            rel="external nofollow noopener" target="_blank">http://www.dungeonwar.online</a></p>
      </li>
      <li>
        <p><strong>You</strong> means the individual accessing or using the Website, or a company, or any legal entity
          on
          behalf of which such individual is accessing or using the Website, as applicable.</p>
      </li>
    </ul>
    ...
    <p>You can learn more about cookies: <a href="https://www.privacypolicies.com/blog/cookies/" target="_blank">What
        Are
        Cookies?</a>.</p>
    <h2>Contact Us</h2>
    ...
    <ul>
      <li>
        <p>By email: dungeonwaronline@gmail.com</p>
      </li>
      <li>
        <p>By visiting this page on our website: <a href="http://www.dungeonwar.online/contacto"
            rel="external nofollow noopener" target="_blank">http://www.dungeonwar.online/contacto</a></p>
      </li>
    </ul>
  </div>
